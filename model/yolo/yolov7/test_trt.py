...
trt_engine = TRT_engine("/home/cyc/pycharm/vGesture/checkpoints/yoloforhuman.engine")
img = cv2.imread("/home/cyc/pycharm/vGesture/test_img/video_0/rgb/0000.png")
results = trt_engine.predict(img,threshold=0.5)
print('results:',results)
img = visualize(img,results)
cv2.imwrite("/home/cyc/pycharm/vGesture/software/yolov7/trtimg3.png",img)