...
class GaussianModel:
    ...
    def training_setup(self, training_args, template=False):
        ...
        if not template:
            l.append({'params': [self._xyz], 'lr': training_args.position_lr_init * self.spatial_lr_scale * self.lr_scale, "name": "xyz"})
    ...
    def save_ply(self, path, clean=False):
