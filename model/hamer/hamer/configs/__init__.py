...
# model/hamer 目录（含 _DATA、hamer_ckpts），与机器无关
_HAMER_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
def get_config(config_file: str, merge: bool = True, update_cachedir: bool = False) -> CN:
    ...
    if update_cachedir:
      ...
      cfg.MANO.MODEL_PATH = update_path(os.path.join(_HAMER_ROOT, cfg.MANO.MODEL_PATH))
