...
class SMPL(_SMPL):
    ...
    def __init__(self, *args, **kwargs):
        ...
        J_regressor_coco=np.load(osp.join(args[0], 'J_regressor_coco.npy'))
        self.register_buffer('J_regressor_h36m', torch.tensor(J_regressor_h36m, dtype=torch.float32))
        self.register_buffer('J_regressor_coco', torch.tensor(J_regressor_coco, dtype=torch.float32))
