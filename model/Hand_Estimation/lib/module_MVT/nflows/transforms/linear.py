...
import lib.module_RLE.nflows.utils.typechecks as check
...
class Linear(Transform):
    ...
    def forward(self, inputs, context=None):
        if not self.training and self.using_cache:
            ...
            return self.forward_no_cache(inputs, context=context)
    ...
    def inverse(self, inputs, context=None):
        if not self.training and self.using_cache:
            ...
            return self.inverse_no_cache(inputs, context=context)
