...
class KeypointPredictNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        ref_joints = batch_triangulate_dlt_cfd_torch(uv_coord_im, K, T_c2m, (pse_vis*uv_confi.detach()).view(B*T, N, self.num_joints))   # (BT, J, 3)
        ...
        outputs = {
            ...
            'ref_joints_master': ref_joints,  # (BT, J, 3)
