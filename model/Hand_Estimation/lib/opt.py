...
_parser.add_argument("-c", "--cfg", help="experiment configure file name", type=str, default='./config/release/GOLF_Inference.yaml')
#_parser.add_argument("-c", "--cfg", help="experiment configure file name", type=str, default='/home/cyc/UST-Hand/config/release/GOLF_FT.yaml')
# _parser.add_argument("-c", "--cfg", help="experiment configure file name", type=str, default='/home/pfren/hth/best/config/release/HaMuCo_DexYCB.yaml')
_parser.add_argument("--exp_id", default="default", type=str, help="Experiment ID")
_parser.add_argument("--input_dir", type=str, default=None, help="Path to user images directory")
_parser.add_argument("--output_dir", type=str, default=None, help="Path to user images directory")
_parser.add_argument("--resume", help="resume training from exp", type=str, default=None)
_parser.add_argument("--ft", help="ft", action='store_true')
_parser.add_argument("--resume_epoch", help="resume from the given epoch", type=int, default=30)
...
"----------------------------- General options -----------------------------"
_parser.add_argument("-g", "--gpu_id", type=str, default='1', help="override enviroment var CUDA_VISIBLE_DEVICES")
...
# _parser.add_argument("--update_interval", default=10, type=int, help="How often to update the pseudo label")
...
_parser.add_argument("--dist_backend", default="nccl", type=str, help="distributed backend")
