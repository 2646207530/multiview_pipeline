...
def evaluate_mAP(res_file, ann_type='bbox', ann_file='person_keypoints_val2017.json', silence=True):
    ...
    ann_file = os.path.join('/home/hth/datasets/coco/annotations/', ann_file)
...
def calc_coord_accuracy(output, labels, hm_shape, output_3d=False, num_joints=None, other_joints=None, root_idx=None):
