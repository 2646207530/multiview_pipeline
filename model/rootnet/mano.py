...
# model/hamer/_DATA/data/mano，与机器无关
_MODEL_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # model/
MANO_ROOT_DEFAULT = os.path.join(_MODEL_DIR, 'hamer', '_DATA', 'data', 'mano')
...
class MANO(object):
    ...
    def get_layer(self):
        return ManoLayer(mano_root=MANO_ROOT_DEFAULT, flat_hand_mean=True, use_pca=False, side='right')