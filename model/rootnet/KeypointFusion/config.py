...
class Config(object):
    ...
    load_model = '/home/cyc/pycharm/vGesture/software/KeypointFusion/checkpoint/dexycb/KPFusion_Dexycb_s0.pth'
    finetune_dir = ''
    ...
    mano_path = osp.join('/home/cyc/pycharm/vGesture/software/KeypointFusion/util/', 'manopth')
