...
from software.KeypointFusion.model.resnet import BasicBlock, Bottleneck
import time
from software.KeypointFusion.model.transfusion_head import updatedDecoder
from software.KeypointFusion.util.generateFeature import GFM
from software.KeypointFusion.model.resnetUnet import OfficialResNetUnet, OfficialResNetUnet_RGB2offset_3D
from software.KeypointFusion.convNeXT.resnetUnet import convNeXTUnet, convNeXTUnet_RGB2offset_3D
import numpy as np
from software.KeypointFusion.pointNet.pointnet2_ops_lib.pointnet2_ops import pointnet2_utils
# from software.KeypointFusion.pointNet import pointnet2_utils
from transformers.models.bert.modeling_bert import BertPreTrainedModel, BertEmbeddings, BertEncoder, BertPooler, \
    BertConfig
from software.KeypointFusion.util.img2pcl import Pcl_utils
...
class Block_KPFusion(nn.Module):
    ...
    def __init__(self, joint_num=21, feature_size=128, num_points=4):
        ...
        config_init = BertConfig.from_pretrained("/home/cyc/pycharm/vGesture/software/KeypointFusion/config/")
        ...
        config_final = BertConfig.from_pretrained("/home/cyc/pycharm/vGesture/software/KeypointFusion/config/")
