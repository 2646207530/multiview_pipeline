...
if __name__ == '__main__':
    ...
    rgb = cv2.imread('/home/cyc/pycharm/vGesture/software/KeypointFusion/test/box_101/101.png')
    depth = cv2.imread('/home/cyc/pycharm/vGesture/software/KeypointFusion/test/box_101/101_d.png', cv2.IMREAD_ANYDEPTH)
    ...
    cv2.imwrite('/home/cyc/pycharm/vGesture/software/KeypointFusion/test/box_101/101_cropRGB.png',cv2.cvtColor(np.uint8(meta_info['crop_img']), cv2.COLOR_BGR2RGB))
    cv2.imwrite('/home/cyc/pycharm/vGesture/software/KeypointFusion/test/box_101/101_cropD.png',meta_info['crop_img_d'])

    cv2.imwrite('/home/cyc/pycharm/vGesture/software/KeypointFusion/test/box_101/101_poseRGB.png', cv2.cvtColor(np.uint8(meta_info['pose_rgb']), cv2.COLOR_BGR2RGB))
    cv2.imwrite('/home/cyc/pycharm/vGesture/software/KeypointFusion/test/box_101/101_poseD.png', meta_info['pose_d'])
